...
vim.env.XDG_USER_DIR = vim.env.XDG_USER_DIR or vim.env.HOME .. "/.local"
vim.env.XDG_DATA_HOME = vim.env.XDG_DATA_HOME or vim.env.XDG_USER_DIR .. "/share"
vim.env.XDG_STATE_HOME = vim.env.XDG_STATE_HOME or vim.env.XDG_USER_DIR .. "/state"
