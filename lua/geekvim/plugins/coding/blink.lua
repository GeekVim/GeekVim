...
return {
    ...
    opts = {
      snippets = {
        expand = function(snippet, _)
          return GeekVim.cmp.expand(snippet)
        end,
      },
      appearance = {
      ...
      completion = {
        ...
        ghost_text = {
          enabled = vim.g.geekvim.enable_ai and vim.g.geekvim.cmp.ai,
        },
      },
  ...
  -- add icons
  {
    ...
    opts = function(_, opts)
      ...
      opts.appearance.kind_icons = vim.tbl_extend("force", opts.appearance.kind_icons or {}, GeekVim.config.icons.kinds)
    end,
  },
