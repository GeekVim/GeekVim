  ...
  return {
    {
      ...
      opts = function(_, opts)
        -- By default, for opts.snippets, mini.snippets only adds gen_loader.from_lang()
        ...
        opts.snippets = { -- override opts.snippets provided by mini.snippets
          -- Load custom file with global snippets first (order matters)
          snippets.gen_loader.from_file(config_path .. "/snippets/global.json"),

          -- Load snippets based on current language by reading files from
          -- "snippets/" subdirectories from 'runtimepath' directories.
          snippets.gen_loader.from_lang(), -- this is the default in mini.snippets
        }
      end,
    },
  }
...
return {
  ...
  desc = "Manage and expand snippets (alternative to Luasnip)",
  {
    ...
    opts = function()
      ...
      GeekVim.cmp.actions.snippet_stop = function() end -- by design, <esc> should not stop the session!
      ---@diagnostic disable-next-line: duplicate-set-field
