...
function M.setup(_, opts)
  ...
  if opts.format then
    GeekVim.warn("**conform.nvim** `opts.format` is deprecated. Please use `opts.default_format_opts` instead.")
  end
    ...
    opts = function()
      ...
      if plugin.config ~= M.setup then
        GeekVim.error({
          ...
          "This will break **GeekVim** formatting.\n",
        }, { title = "GeekVim" })
      end
