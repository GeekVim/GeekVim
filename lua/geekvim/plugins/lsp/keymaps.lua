...
function M.get()
  if M._keys then
    ...
    M._keys =  {
      ...
      { "<leader>cA", GeekVim.lsp.action.source, desc = "Source Action", has = "codeAction" },
...
function M.has(buffer, method)
  ...
  local clients = GeekVim.lsp.get_clients({ bufnr = buffer })
...
function M.resolve(buffer)
  ...
  local opts = GeekVim.opts("nvim-lspconfig")
  local clients = GeekVim.lsp.get_clients({ bufnr = buffer })
  for _, client in ipairs(clients) do
