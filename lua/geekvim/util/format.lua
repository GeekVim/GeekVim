...
function M.formatexpr()
  if GeekVim.has("conform.nvim") then
...
function M.format(opts)
  ...
  if not done and opts and opts.force then
    GeekVim.warn("No formatter available", { title = "GeekVim" })
  end
end
...
function M.snacks_toggle(buf)
  return Snacks.toggle({
    ...
    get = function()
      ...
      return GeekVim.format.enabled()
    end,
    set = function(state)
      GeekVim.format.enable(state, buf)
    end,
  })
end
